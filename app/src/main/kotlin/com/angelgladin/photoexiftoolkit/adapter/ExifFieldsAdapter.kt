 ...
 * Created on 12/22/16.
 */
class ExifFieldsAdapter(val exifList: MutableList<ExifTagsContainer>, val presenter: PhotoDetailPresenter) : RecyclerView.Adapter<ExifFieldsAdapter.ViewHolder>() {
